...
//
// Loop over this array with the map method that will produce a new array and change the string numbers to actual numbers. Store the result in a variable.

const numbers = ["2", "5", "100"];
let result = numbers.map((number) => parseInt(number));

// 2.2- string to float
//
// You are given this array:
//
// const floatNumbers = ["2.5", "5.9", "100.33"];Loop over this array with the map method that will produce a new array and change the string numbers to actual float numbers. Store the result in a  variable.

const floatNumbers = ["2.5", "5.9", "100.33"];
let result2 = floatNumbers.map((number) => parseFloat(number));

// 2.3 – Array of names
// Iterate over your data with the map method and produce a new array with just the names of the movies. Store the result in a variable.
...
let result3 = movies.map((movie) => movie.name);

// 2.4- Array of Objects
//
// Iterate over your data with the map method and produce a new array of objects. Each object should include the following of each movie:
//
...
let result4 = {};
result4 = movies.map((movie) => ({ name: movie.name, genre: movie.genre }));
